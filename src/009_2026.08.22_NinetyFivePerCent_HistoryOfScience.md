...
slack: The Alkali Act of 1863 told British chemical works to capture ninety-five per cent of the hydrochloric acid going up their chimneys, and it is arguably the first emission standard with a number in it. What makes the story worth more than its antiquarian charm is what happened next: the captured acid turned out to be worth selling, the dirty Leblanc process survived decades past its economic death anyway, and the definition of waste turned out to be a function of price rather than chemistry.
burned:
